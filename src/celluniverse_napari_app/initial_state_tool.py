...
class InitialStateBuilder(QtWidgets.QWidget):
    ...
    def _build_ui(self) -> None:
        ...
        voxel_compact_widget = QtWidgets.QWidget()
        voxel_compact_widget.setObjectName("CompactRow")
        voxel_compact_layout = QtWidgets.QGridLayout(voxel_compact_widget)
        voxel_compact_layout.setContentsMargins(0, 0, 0, 0)
        voxel_compact_layout.setHorizontalSpacing(12)
        voxel_compact_layout.setVerticalSpacing(6)
        x_voxel_label = QtWidgets.QLabel("x voxel")
        y_voxel_label = QtWidgets.QLabel("y voxel")
        z_voxel_label = QtWidgets.QLabel("z voxel")
        colormap_label = QtWidgets.QLabel("colormap")
        voxel_compact_layout.addWidget(x_voxel_label, 0, 0)
        voxel_compact_layout.addWidget(self.voxel_x, 1, 0)
        voxel_compact_layout.addWidget(y_voxel_label, 0, 1)
        voxel_compact_layout.addWidget(self.voxel_y, 1, 1)
        voxel_compact_layout.addWidget(z_voxel_label, 0, 2)
        voxel_compact_layout.addWidget(self.voxel_z, 1, 2)
        voxel_compact_layout.addWidget(colormap_label, 0, 3)
        voxel_compact_layout.addWidget(self.colormap_combo, 1, 3)
        voxel_compact_layout.setColumnStretch(0, 1)
        voxel_compact_layout.setColumnStretch(1, 1)
        voxel_compact_layout.setColumnStretch(2, 1)
        voxel_compact_layout.setColumnStretch(3, 1)
        voxel_form.addRow(voxel_compact_widget)
        ...
        self.auto_detect_button = QtWidgets.QPushButton("Auto Detect(Cell Lumen)")
        ...
        shape_compact_widget = QtWidgets.QWidget()
        shape_compact_layout = QtWidgets.QGridLayout(shape_compact_widget)
        shape_compact_layout.setContentsMargins(0, 0, 0, 0)
        shape_compact_layout.setHorizontalSpacing(12)
        shape_compact_layout.setVerticalSpacing(6)
        x_center_label = QtWidgets.QLabel("x center")
        y_center_label = QtWidgets.QLabel("y center")
        z_center_label = QtWidgets.QLabel("z center")
        radius_x_label = QtWidgets.QLabel("x radius a")
        radius_y_label = QtWidgets.QLabel("y radius b")
        radius_z_label = QtWidgets.QLabel("z radius c")
        shape_compact_layout.addWidget(x_center_label, 0, 0)
        shape_compact_layout.addWidget(self.x_spin, 1, 0)
        shape_compact_layout.addWidget(y_center_label, 0, 1)
        shape_compact_layout.addWidget(self.y_spin, 1, 1)
        shape_compact_layout.addWidget(z_center_label, 2, 0)
        shape_compact_layout.addWidget(self.z_spin, 3, 0)
        shape_compact_layout.addWidget(radius_x_label, 2, 1)
        shape_compact_layout.addWidget(self.a_spin, 3, 1)
        shape_compact_layout.addWidget(radius_y_label, 4, 0)
        shape_compact_layout.addWidget(self.b_spin, 5, 0)
        shape_compact_layout.addWidget(radius_z_label, 4, 1)
        shape_compact_layout.addWidget(self.c_spin, 5, 1)
        shape_compact_layout.setColumnStretch(0, 1)
        shape_compact_layout.setColumnStretch(1, 1)
        shape_form.addRow(shape_compact_widget)
    ...
    def _set_auto_detect_running(self, running: bool) -> None:
        if hasattr(self, "auto_detect_button"):
            ...
            self.auto_detect_button.setText("Running..." if running else "Auto Detect(Cell Lumen)")
